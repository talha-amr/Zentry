...
const Features = () => {
  return (
    <section className="min-h-dvh w-screen bg-black">
      <div className="container mx-auto pt-20 md:pt-40 px-4 md:px-35">
        ...
        <div className="flex flex-col gap-6 md:grid md:grid-cols-2 md:grid-rows-2 md:gap-20 md:h-[100vh]">
          {/* Left big card */}
        ...
        `<div className="flex flex-col gap-4 md:flex-row md:gap-6 md:h-70 mt-8 md:mt-10 justify-center items-center">

        <BentoCard
        title="MORE COMING SOON"
        className="bg-blue-950 w-full md:w-auto min-h-[200px] md:h-full"
        />

        <BentoCard
        video="videos/feature-5.mp4"
        className="w-full md:w-auto min-h-[200px] md:h-full"
        />
